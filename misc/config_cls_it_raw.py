...
class Config(object):
    def __init__(self):
        self.task = 'classification_from_scratch: use NoFindings as N for pos_weight, set upperbound as 5'
        ...
        self.init_text_encoder_path = ''
        self.init_image_encoder_path = '/media/My1TBSSD1/IPMI2021/pretrained/image_encoder28.pth'  # the pretrained checkpoint used for initialize the image encoder backbone
