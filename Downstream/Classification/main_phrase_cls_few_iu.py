...
from dataset_iu_cls import build_dataset
from trainer_phrase_cls_iu_few import JoImTeR as trainer
...
if __name__ == "__main__":
    ...
    data_set = build_dataset('few5', cfg, output_dir)
    ...
    val_data_set = build_dataset('test5', cfg, output_dir)
